...
const AdminInStockProducts = () => {
  const { products } = useContext(ProductsContextProvider);
  const [inStockProducts, setInStockProducts] = React.useState([]);
  useEffect(() => {
  ...
  return (
    <>
      <h3 className="text-3xl md:hidden block text-center text-green-600 font-bold">
        في المخزون
      </h3>
      <div className="flex flex-col items-center bg-green-800/20 p-5 w-full rounded-xl mt-2 mx-auto -mr-2">
...
export default AdminInStockProducts;
