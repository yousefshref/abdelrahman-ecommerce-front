...
export const aboutUsPagePath = () => `/aboutUs`;
export const privacyPagePath = () => `/privacy_policy`;
export const refundPagePath = () => `/refund_policy`;
export const Stock = () => `/Stock`;
export const adminAnalysis = () => `/admin/analysis/`;
export const adminSettingsAddition = () => `/admin/settings/addition/`;
