    ...
    <AdminLayout>
      ...
      <div className="md:px-5">
        <div className="flex gap-2 items-center">
          <Avatar src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" />
          <FaBell className="text-2xl" />
        </div>
        <div className="flex flex-col-reverse md:flex-row justify-between items-center mt-10">
          <div className="flex lg:gap-10 md:gap-5 gap-2 items-center">
            <Button
          ...
          <h3 className="text-4xl font-bold">Product List</h3>
        </div>
        <ProductsList
          products={products}
      ...
      {/* create modeal */}
      <UpdateOrCreateProduct isOpen={isOpen} onClose={onClose} />
    </AdminLayout>
  );
};
